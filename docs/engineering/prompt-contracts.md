...
**Sürüm:** v0.4
**Son güncelleme:** 2026-05-16 (v0.8 — #888 §4: sohbet hafızası is_related'dan decouple (followup_block koşulsuz; #884'ün çalışma önkoşulu — kök mimari). v0.7 — #884 condense AÇIK ÖZNE İSTİSNASI + agent "anma≠tanım"/proaktif tutarlılık. v0.6 — #879 temporal-grounding. v0.5 — denetim staleness sync. Önceki: 2026-05-11 (v0.4 — #686 HyDE; #688 content_max_tokens; #677 halüsinasyon yasağı)
