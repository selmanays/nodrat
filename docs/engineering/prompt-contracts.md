...
**Sürüm:** v0.4
**Son güncelleme:** 2026-05-15 (v0.6 — #879 §4 tool-use akışına temporal-grounding fix notu: search_news yayın tarihi + SYSTEM_PROMPT_NODRAT_AGENT genel zaman kuralı (#845 regresyon)). v0.5 — denetim staleness sync: §1 "Confidence Router routing yapar" + "meta_query #815" SUPERSEDED. Önceki: 2026-05-11 (v0.4 — #686 HyDE; #688 content_max_tokens; #677 halüsinasyon yasağı)
