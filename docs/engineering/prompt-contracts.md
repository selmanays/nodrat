...
**Sürüm:** v0.4
**Son güncelleme:** 2026-05-16 (v0.7 — #884 §4: condense AÇIK ÖZNE İSTİSNASI (3. scope ayrımı) + agent "anma≠tanım"/proaktif tutarlılık). v0.6 — #879 temporal-grounding (search_news yayın tarihi + genel zaman kuralı, #845 regresyon). v0.5 — denetim staleness sync (confidence-router/meta_query SUPERSEDED). Önceki: 2026-05-11 (v0.4 — #686 HyDE; #688 content_max_tokens; #677 halüsinasyon yasağı)
