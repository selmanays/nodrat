...
| Son güncelleme | 2026-05-20 — Phase 2 PR 6 açılıyor: `modules/clusters/` altıncı modül taşıma (sadece article-event clustering — 3 dosya; research_clustering + cluster_assigner generations Phase 6'ya bırakıldı); Phase 2 PR 5 ([#1105](https://github.com/selmanays/nodrat/pull/1105)) merged → main HEAD `9991251` |
| Bir sonraki adım | Phase 2 PR 6 review + merge → runtime-sensitive PR 7 (settings_admin) + PR 8 (prompts_admin). Pattern olgunlaştı, Phase 2 son iki PR runtime/Redis pub/sub doğrulamasıyla. |
