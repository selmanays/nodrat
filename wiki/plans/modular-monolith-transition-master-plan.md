...
| Son güncelleme | 2026-05-20 — Phase 2 PR 5 açılıyor: `modules/media/` beşinci modül taşıma (6 dosya — orta coupling; helpers + tasks + admin tek atomik PR'da); Phase 2 PR 4 ([#1104](https://github.com/selmanays/nodrat/pull/1104)) merged → main HEAD `d0d7465` |
| Bir sonraki adım | Phase 2 PR 5 review + merge → Phase 2 PR 6 (clusters), sonra runtime-sensitive PR 7-8 (settings_admin, prompts_admin) |
