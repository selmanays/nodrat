...
| 5.3 | Stüdyo UI + onay | **5.3a ✅** (#1791): `app/me/automation/*` API (kural CRUD + onay-kuyruğu approve/reject) + feed-gizleme (onaylanana kadar görünmez). **5.3b 🔜**: kural-kurucu + onay-kuyruğu UI (Next.js/shadcn) | `automation.studio.enabled` | flag OFF → 403/UI gizli | 5.3a ✅ · 5.3b 🔜 |
