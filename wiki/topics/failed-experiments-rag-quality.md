...
> - **Faz-D (planlı, devam):** gerçek TR stemmer (`snowballstemmer`) flag-OFF spike + #947 over-stem invariant pytest gate (merge-bloklayıcı). #927 epic Faz-D sonrası kapanır.
