...
| T8-7 🛑 v77 DEFERRED | `ops/models.py` (jobs + audit + provider_log) | `FailedJob`, `AdminAuditLog`, `ProviderCallLog` | `ops` | **HARD-STOP** | **15 caller (cost_tracker core/-importer; ≫ 8 limit)** — Option B local proof bekleniyor; FAIL → T7 cost_tracker initiative öncelik |
