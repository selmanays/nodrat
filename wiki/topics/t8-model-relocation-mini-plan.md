...
| T8-7 🚫 v78 DEFERRED | `ops/models.py` (jobs + audit + provider_log) | `FailedJob`, `AdminAuditLog`, `ProviderCallLog` | `ops` | **HARD-STOP** | **15 caller (cost_tracker core/-importer; ≫ 8 limit)** — **Option B local proof FAIL v78** (facade path da `core/* → modules/*` ihlali; POISONED facade insight); T7 cost_tracker initiative ([#1086](https://github.com/selmanays/nodrat/issues/1086)) gerçek unblocker (kullanıcı yetki bekliyor) |
