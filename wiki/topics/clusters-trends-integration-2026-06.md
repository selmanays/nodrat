...
- ~~NER gürültüsü (jenerik kelime "var"/"bugün" org/person mis-type)~~ → **ÇÖZÜLDÜ #1598**: paylaşımlı [[ner-noise-stopword-filter]] (`core/entity_noise`) hem NER ingest hem çapa gate'inde → "var"/"bugün"/"zaman" kaynakta elenir, trend×küme tek temiz taban. (Belirsizler küba/borsa kasıtla korunur.)
