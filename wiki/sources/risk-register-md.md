...
source_version: "v0.3"
source_updated: "2026-05-08 (v0.3 — Lemon Squeezy MoR pivot Epic #448: yeni R-FIN-04 LS dependency + R-FIN-05 USD/TRY FX + R-LGL-13 KVKK m.9; R-LGL-10 vergi/e-Fatura mitigated LS keser)"
...
3. **MVP-1 ↔ MVP-2 ↔ MVP-3 fonksiyonel kapsam farkı net:** MVP-1 "çalışan minimum"; MVP-2 "kullanılabilir SaaS" (selector UI, category page, X thread, comparison flag); MVP-3 "ücretli launch" (ödeme — **Lemon Squeezy MoR** [[lemon-squeezy-payment-provider]], e-Arşiv kalktı LS keser, stil profili). Iyzico + Limited Şti. + e-Arşiv altyapısı 2026-05-08 itibarıyla reddedildi (Epic #448).
