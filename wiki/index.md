...
- Toplam sayfa: **111** (**15 entity** + **25 concept** + 6 topic + **27 decision** + **35 source** + 3 hub) — 2026-05-11: MVP-1.8 #684 + #691 + #696 (D16+E19+E20) + #700 + #698 docs-update + 5-doc detay extraction pilot. **Bu sprintte 15 yeni detay sayfa**: 5 yeni locked decision (age-gate-18-plus, model-improvement-default-opt-out, pre-launch-security-checklist, margin-70-target, geographic-pricing-policy), 2 persona entity (P1A politik creator, P1B ajans), 8 concept (output-liability-disclaimer, insufficient-data-pattern, stride-threat-analysis, ai-specific-threats, pricing-tier-matrix, shared-cost-haber-havuzu, variable-cost-uretim, trial-conversion-funnel).
...
- Açık locked decision: **20** (#440 sonrası 2 + Epic #448 sonrası 1 + 2026-05-09: shadcn-customization-policy + sse-streaming-default + 2026-05-10: realtime-rss-polling + own-slm-strategy + 2026-05-11: cards-path-ner-out-of-scope + age-gate-18-plus + model-improvement-default-opt-out + pre-launch-security-checklist + margin-70-target + geographic-pricing-policy)
