...
- [[cross-encoder-rerank-disabled|Cross-encoder reranker production'da kapalı]] — `rerank.enabled=false` (2026-05-10'dan beri). NIM rerank kalite sorunları (#251/#252/#254/#259/#260) + local bge-reranker eval gate negatif (#347) → bilinçli kapalı. Pipeline RRF + NER (#667) + mode-aware phrase boost (#718) + LLM rerank Faz 4 (`retrieval.llm_rerank_enabled=true`) kombinasyonu ile çalışır. Üretim: 9-10/11 niş entity recall@5 (#719). Geri açma yolu: eval framework + NDCG@10 ≥ 0.90.
