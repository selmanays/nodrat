...
- Toplam sayfa: **59** (**13 entity** + **18 concept** + 5 topic + **21 decision** + 2 source) — 2026-05-11: MVP-1.8 #667-#679 Faz 6+7a delivered → +1 yeni: [[ner-pipeline]] (decision). 10 PR ile UI seviyesinde 27.3% → ~82% (9-10/11 niş entity sorgu). NER pipeline + 7 prompt fix + halüsinasyon yasağı + sufficiency archive bypass. Faz 7b embedding upgrade (bge-m3 → e5-multilingual-large) plan açık.
