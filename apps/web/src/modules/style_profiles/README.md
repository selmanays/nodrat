# `src/modules/style_profiles/`

**Layer:** middle — frontend mirror of `apps/api/app/modules/style_profiles/`.
...
- API client (`api/style_profiles-api.ts` — `src/lib/api.ts` base infra'sını kullanır)
- Custom hooks
- Types

## References

- Backend mirror: [`apps/api/app/modules/style_profiles/README.md`](../../../../api/app/modules/style_profiles/README.md)
