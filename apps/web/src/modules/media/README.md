...
**Layer:** middle — frontend mirror of `apps/api/app/modules/media/`.
...
- API client (`api/media-api.ts` — `src/lib/api.ts` base infra'sını kullanır)
- Custom hooks
- Types

## References

- Backend mirror: [`apps/api/app/modules/media/README.md`](../../../../api/app/modules/media/README.md)
