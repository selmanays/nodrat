...
**Layer:** middle — frontend mirror of `apps/api/app/modules/rag/`.
...
- API client (`api/rag-api.ts` — `src/lib/api.ts` base infra'sını kullanır)
- Custom hooks
- Types

## References

- Backend mirror: [`apps/api/app/modules/rag/README.md`](../../../../api/app/modules/rag/README.md)
