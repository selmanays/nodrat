# `src/modules/prompts_admin/`

**Layer:** parallel — frontend mirror of `apps/api/app/modules/prompts_admin/`.
...
- API client (`api/prompts_admin-api.ts` — `src/lib/api.ts` base infra'sını kullanır)
- Custom hooks
- Types

## References

- Backend mirror: [`apps/api/app/modules/prompts_admin/README.md`](../../../../api/app/modules/prompts_admin/README.md)
