...
**Layer:** upper — frontend mirror of `apps/api/app/modules/generations/`.
...
- API client (`api/generations-api.ts` — `src/lib/api.ts` base infra'sını kullanır)
- Custom hooks
- Types

## References

- Backend mirror: [`apps/api/app/modules/generations/README.md`](../../../../api/app/modules/generations/README.md)
