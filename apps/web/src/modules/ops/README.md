...
**Layer:** cross-cutting — frontend mirror of `apps/api/app/modules/ops/`.
...
- API client (`api/ops-api.ts` — `src/lib/api.ts` base infra'sını kullanır)
- Custom hooks
- Types

## References

- Backend mirror: [`apps/api/app/modules/ops/README.md`](../../../../api/app/modules/ops/README.md)
