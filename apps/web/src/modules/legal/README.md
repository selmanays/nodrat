...
**Layer:** parallel — frontend mirror of `apps/api/app/modules/legal/`.
...
- API client (`api/legal-api.ts` — `src/lib/api.ts` base infra'sını kullanır)
- Custom hooks
- Types

## References

- Backend mirror: [`apps/api/app/modules/legal/README.md`](../../../../api/app/modules/legal/README.md)
