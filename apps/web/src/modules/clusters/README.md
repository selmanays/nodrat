...
**Layer:** middle — frontend mirror of `apps/api/app/modules/clusters/`.
...
- API client (`api/clusters-api.ts` — `src/lib/api.ts` base infra'sını kullanır)
- Custom hooks
- Types

## References

- Backend mirror: [`apps/api/app/modules/clusters/README.md`](../../../../api/app/modules/clusters/README.md)
