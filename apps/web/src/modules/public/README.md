...
**Layer:** cross-cutting — frontend mirror of `apps/api/app/modules/public/`.
...
- API client (`api/public-api.ts` — `src/lib/api.ts` base infra'sını kullanır)
- Custom hooks
- Types

## References

- Backend mirror: [`apps/api/app/modules/public/README.md`](../../../../api/app/modules/public/README.md)
