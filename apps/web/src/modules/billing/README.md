...
**Layer:** parallel — frontend mirror of `apps/api/app/modules/billing/`.
...
- API client (`api/billing-api.ts` — `src/lib/api.ts` base infra'sını kullanır)
- Custom hooks
- Types

## References

- Backend mirror: [`apps/api/app/modules/billing/README.md`](../../../../api/app/modules/billing/README.md)
