...
**Layer:** parallel — frontend mirror of `apps/api/app/modules/accounts/`.
...
- API client (`api/accounts-api.ts` — `src/lib/api.ts` base infra'sını kullanır)
- Custom hooks
- Types

## References

- Backend mirror: [`apps/api/app/modules/accounts/README.md`](../../../../api/app/modules/accounts/README.md)
