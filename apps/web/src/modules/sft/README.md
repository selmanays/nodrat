...
**Layer:** middle — frontend mirror of `apps/api/app/modules/sft/`.
...
- API client (`api/sft-api.ts` — `src/lib/api.ts` base infra'sını kullanır)
- Custom hooks
- Types

## References

- Backend mirror: [`apps/api/app/modules/sft/README.md`](../../../../api/app/modules/sft/README.md)
