...
**Layer:** kernel — frontend mirror of `apps/api/app/modules/sources/`.
...
- API client (`api/sources-api.ts` — `src/lib/api.ts` base infra'sını kullanır)
- Custom hooks
- Types

## References

- Backend mirror: [`apps/api/app/modules/sources/README.md`](../../../../api/app/modules/sources/README.md)
