...
**Layer:** kernel — frontend mirror of `apps/api/app/modules/articles/`.
...
- API client (`api/articles-api.ts` — `src/lib/api.ts` base infra'sını kullanır)
- Custom hooks
- Types

## References

- Backend mirror: [`apps/api/app/modules/articles/README.md`](../../../../api/app/modules/articles/README.md)
