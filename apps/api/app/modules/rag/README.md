...
**Status:** Phase 1 scaffold (empty). Implementation arrives in **Phase 5**.

This directory is a placeholder for the future `rag` module. No Python code yet — `__init__.py` is empty.
