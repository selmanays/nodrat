...
**Status:** Phase 1 scaffold (empty). Implementation arrives in **Phase 3**.

This directory is a placeholder for the future `articles` module. No Python code yet — `__init__.py` is empty.
