...
**Layer:** cross-cutting — see [`wiki/plans/modular-monolith-transition-master-plan.md`](../../../../wiki/plans/modular-monolith-transition-master-plan.md) §2.

**Status:** Phase 1 scaffold (empty). Implementation arrives in **Phase 4**.

This directory is a placeholder for the future `public` module. No Python code yet — `__init__.py` is empty.
