...
| Architecture | v0.8 | 2026-05-17 | #917 §3.2 backfill_discovered de deneme-tabanlı (yaş-tabanlı `created_at` tavanı kaldırıldı — #904 anti-pattern kardeş task'ta kapandı, 75 orphan kök). Önceki #904 §3.2 extraction cascade + failure routing (Tier-0 JSON-LD→density→fallback, gate yönlendirici, per-domain telemetri) / #893 / #685 / #696 korunur. |
