...
└── docs/
    ...
    │   ├── alarm-thresholds.md                # Operational alarm eşikleri
    │   ├── modular-monolith-architecture.md   # Modüler monolit spec (modüller + import yönü)
    │   ├── refactor-playbook.md               # Refactor SOP (facade-first, behavior-preserving)
    │   └── testing-strategy.md                # Test katmanları + CI gates + characterization
    │
    ├── design/                                # UX + marka
    ...
    │   ├── ropa.md                            # Veri İşleme Envanteri (TIA §16.1 dahil)
    │   ├── incident-response.md               # 72h KVKK ihlal playbook
    │   ├── refund-policy.md                   # İade Politikası (Epic #448, LS hosted refund)
    │   ├── mesafeli-satis-sozlesmesi.md       # TR Mesafeli Sözleşme (Epic #448)
    │   └── payment-fallback-plan.md           # R-FIN-04 Paddle 6-senaryo aksiyon (Epic #448)
    │
...
✅ Default LLM:     DeepSeek V4 Flash ($0.14 cache-miss / $0.0028 cache-hit / $0.28 output per 1M — indirim YOK)
...
| Legal Compliance Brief | v0.3 | 2026-05-08 | Avukat + Vergi Danışmanı görüşü integrated (Epic #448 §3.9 N-09 + §3.10 N-10 RESOLVED) |
| Legal Opinion Integration | v0.3 | 2026-05-08 | §3.9 N-09 RESOLVED (avukat 6 cevap, 7 ön-launch maddesi); §3.10 N-10 INTEGRATED (vergi danışmanı 7 madde, threshold matrisi) |
| Refund Policy | v0.1 | 2026-05-08 | YENİ — LS hosted refund + 14 gün cayma (Epic #448) |
